...
export const learningCards = [
  {
    title: "先说出你的目标",
    body: "像平时说话一样描述你想完成什么，不需要先懂 Skill 文件结构或写法。",
  },
  {
    title: "再补充你的资料",
    body: "文章、截图、图片、视频链接、旧 Skill 都可以加进来，系统会一起参考。",
  },
  {
    title: "最后导出使用",
    body: "生成后先看说明和示例，再导出成压缩包，后续可以继续修改和复用。",
  },
];
...
export const faqs = [
  ...
  {
    q: "支持哪些资料类型？",
    a: "目前支持文字资料、图片、视频链接备注，以及已有的 SKILL.md 内容。建议先从最简单的文字资料开始，熟悉后再逐步补充更多内容。",
  },
];
