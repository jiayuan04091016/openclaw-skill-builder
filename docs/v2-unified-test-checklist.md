...
- `GET /api/internal/v2-capability-readiness`
- `GET /api/internal/v2-capability-readiness?format=markdown`

通过标准：
- `v2-smoke` 返回 `allPassed: true`
- 六项检查都为 `ok: true`
- `v2-capability-readiness` 能明确给出当前阻塞项和下一步
- Markdown 报告能正常输出中文
